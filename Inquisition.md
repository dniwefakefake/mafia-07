...
* **Упрощение казни(ульт):** в следующие сумерки цель будет казнена, если за неё наберется 30% голосов. Не отображается. Если на кого-то другого наберётся более 50% голосов, тот будет казнен вместо этой цели. Имеет приоритет перед пассивкой "важный". В случае применения этой способности на двоих игроков, будет казнен тот, за которого будет дано больше голосов (если число голосов равно, то казнен не будет никто)

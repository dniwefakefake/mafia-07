...
#### Дневные действия:
* **Сфера Отрицания (ульт):** блокирует любые воздействия на  Дневной Дозор в течение следующих ночной и дневной фазы. Должно быть поддержано Юрием или Николаем. Не отображается в газете
